...
var HomeView = (_dec = (0, _reactRedux.connect)(function (state) {
  ...
  _createClass(HomeView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement(_reactHelmet2.default, { title: 'Home | React Address Book' }), _react2.default.createElement('div', { className: 'page-header' }, _react2.default.createElement('h1', null, 'Home')), _react2.default.createElement(_SearchPanel2.default, null), _react2.default.createElement(_ContactsPanel2.default, { filter: filter }), _react2.default.createElement(_reactRouter.Link, { className: 'btn btn-default', to: '/contact' }, 'Add New Contact'));
